...
public class Ejercicio09 {
	...
	public static void main(String[] args) {
		//Leer por teclado una serie de n números. La aplicación debe indicarnos si los números están 
		//ordenados de forma creciente, decreciente o si no están ordenados
		int cantidad = 0;
		do {

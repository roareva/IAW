...
public class Ejercicio07 {
	...
	// un centro
	// educativo. Cada clase está compuesta por 10 alumnos. Se pide leer las notas
	// del primer,
	// segundo y tercer trimestre almacenándolas en una tabla. Debemos mostrar la
	// nota media final de
	// cada alumno y de cada clase en cada trimestre. Por último, desarrolle un
	// método que se le
	// pase un número de alumno y devuelve la media final de ese alumno.
